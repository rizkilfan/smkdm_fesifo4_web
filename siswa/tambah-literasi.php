...
<head>
    ...
    <title>Tambah Literasi - AKSARA+</title>
                ...
                <div class="comic-border bg-white p-4 p-md-5">
                    ...
                    <form method="POST">
                        <div class="mb-3">
                            ...
                            <input type="text" name="judul" class="form-control comic-input" 
                                   placeholder="Contoh: Laskar Pelangi..." required>
                        </div>

                        <div class="mb-3">
                            <label class="fw-bold mb-1">PENULIS / PENGARANG</label>
                            <input type="text" name="penulis" class="form-control comic-input" 
