...
<body class="bg-light">
    ...
    <div class="container">
        <!--  ganti warnanya kalau warna kartunya kurang cocok -->
        ...
        <div class="row mb-3 align-items-center">
            <div class="col-md-6">
                <h3 class="fw-black uppercase m-0">Riwayat Literasi Anda</h3>
            </div>
            <div class="col-md-6 text-md-end mt-3 mt-md-0">
                <a href="tambah-literasi.php" class="btn btn-info comic-btn">
                    + TAMBAH LITERASI
                </a>
            </div>
        </div>
                ...
                <table class="table table-hover mb-0">
                    <thead class="table-dark">
                        <tr>
                            ...
                            <th class="py-3 text-center">CATATAN GURU</th>
                        </tr>
                    </thead>
                    <tbody>
                        <!--  ini teh logika sesuai tulisan pending,disetujui atau ditolak yh -->
                        <?php
