...
// queryna tong diubah ubah deui.... kieu gs cukup... paling limit tambahan bis erek... --ranti
...
<body>
    ...
    <header class="hero-section text-center">
        <div class="container position-relative">
            ...
            <p class="lead fw-bold mb-4 bg-white d-inline-block px-3 border border-dark">Ayo catat bacaanmu dan jadilah juara literasi sekolah.</p>
            <div class="mt-4">
    ...
    <main class="container my-5">
        <div class="row g-5">
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        <div class="comic-border info-card">
                            <h5 class="fw-bold"><i class="fa-solid fa-plug-circle-bolt"></i>CEPAT</h5>
                    ...
                    <div class="col-md-6">
                        <div class="comic-border info-card">
                            <h5 class="fw-bold"><i class="fa-solid fa-flag-checkered"></i>KOMPETISI</h5>
            ...
            <!-- tii.. ke ieu container na rada di scroll keun mun bsia mah --rangga -->
                    ...
                    <table class="table table-striped mb-0">
                        ...
                        <tbody>
                            <?php if(empty($leaderboard)): ?>
                                <tr>
                                    <td colspan="2" class="text-center py-4">Belum ada pahlawan literasi.</td>
                                </tr>
                            <?php else: ?>
                                ...
                                <tr class="align-middle">
                                    ...
                                    <td class="text-center">
                                        <span class="badge badge-comic px-3 py-2"><?= $l['jumlah'] ?> BUKU</span>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            <?php endif; ?>
    ...
    <footer class="py-5 mt-5">
        <div class="container text-center">
            ...
            <p class="small text-secondary mb-0">SMKS DARUL MUKMININ - 2026 | FESIFO 4.0</p>
        </div>
    </footer>
