    ...
    <div class="container">
        ...
        <div class="col-md-5 col-lg-6">
            ...
            <div class="text-center mb-4">
                ...
                <span class="bagde-comic">Aksi kritis saring ragam informasi digital</span>
            </div>

            <div class="comic-border bg-white p-4 p-md-5">
                <h3 class="fw-black tect-center mb-4 uppercase"> MASUK SEKARANG</h3>
                <?php if (isset($error)): ?>
                ...
                <form method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="password" class="form-control comic-input" placeholder="******" required>
                    </div>
                    <button type="submit" name="login" class="btn btn-warning vomic-btn w-100 py-3">
                        GAS MASUK! <i class="fa-barnds fa-space-awesome"></i>
                    </button>
                </form>
